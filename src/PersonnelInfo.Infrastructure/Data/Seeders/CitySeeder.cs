...
public class CitySeeder
{
    ...
    {
        var filePath = Path.Combine(Directory.GetParent(Directory.GetCurrentDirectory()).Parent.Parent.Parent.Parent.FullName, "src", "PersonnelInfo.Infrastructure", "Data", "Seeds", "Cities.json");
